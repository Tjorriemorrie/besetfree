...
class Bread extends React.Component {
    ...
    render() {
        ...
        let is_bread = this.props.pathname == '/resources/bread'

        console.info('[Bread] render', is_main, is_bread)

        if (!is_main && !is_bread) {
            return null
        }

        return <div className="resource bread">
            <a name="bread"/>
            <div className="wrapper">
                <div className="main">
                    <div>
                        ...
                        {(is_main && !is_bread)
                            ? <p><Link to="/resources/bread" activeClassName="active"><button>+ expand</button></Link></p>
                            : null
                        }
                    </div>
                    <div>
                ...
                {this.renderMore(is_bread)}
            </div>
        </div>
    }

    renderMore(is_bread) {
        console.info('[Bread] renderMore')
        ...
        return <div className="content">
            ...
            <p className="collapse"><Link to="/resources#bread" activeClassName="active"><button>&minus; collapse</button></Link></p>
        </div>
    }
}
