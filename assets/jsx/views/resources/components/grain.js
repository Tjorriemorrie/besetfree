...
class Grain extends React.Component {
    ...
    render() {
        ...
        let is_grain = this.props.pathname == '/resources/grain'

        console.info('[Grain] render', is_main, is_grain)

        if (!is_main && !is_grain) {
            return null
        }

        return <div className="resource grain">
            <a name="grain"/>
            <div className="wrapper">
                <div className="main">
                    <div>
                        ...
                        {(is_main && !is_grain)
                            ? <p><Link to="/resources/grain" activeClassName="active"><button>+ expand</button></Link></p>
                            : null
                        }
                    </div>
                    <div>
                ...
                {this.renderMore(is_grain)}
            </div>
        </div>
    }

    renderMore(is_grain) {
        console.info('[Grain] renderMore')
        ...
        return <div>
            ...
            <p className="collapse"><Link to="/resources#grain" activeClassName="active"><button>&minus; collapse</button></Link></p>
        </div>
    }
}
