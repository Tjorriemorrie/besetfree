...
class Breakfast extends React.Component {
    ...
    render() {
        ...
        let is_breakfast = this.props.pathname == '/resources/breakfast'

        console.info('[Breakfast] render', is_main, is_breakfast)

        if (!is_main && !is_breakfast) {
            return null
        }

        return <div className="resource breakfast">
            <a name="breakfast"/>
            <div className="wrapper">
                <div className="main">
                    ...
                    <div>
                        ...
                        {(is_main && !is_breakfast)
                            ? <p><Link to="/resources/breakfast" activeClassName="active"><button>+ expand</button></Link></p>
                            : null
                        }
                    </div>
                </div>
                {this.renderMore(is_breakfast)}
            </div>
        </div>
    }

    renderMore(is_breakfast) {
        console.info('[Breakfast] renderMore')
        ...
        return <div>
            <div className="flex-parent">
                ...
                <div className="exp-main">
                    ...
                    <div className="carbs">
                        ...
                        <iframe width="640" height="315" src="https://www.youtube.com/embed/pP42TUmHjto" frameborder="0" allowfullscreen></iframe>
            ...
            <p className="collapse"><Link to="/resources#breakfast" activeClassName="active"><button>&minus; collapse</button></Link></p>
        </div>
    }
}
